...
public class PageUtilTwo {
	 ...
	 * */
	public PageUtilTwo(int currentPage,int count, int rowCount) {
	...
	public PageUtilTwo(String keyfield, String keyword, int currentPage, int count, int rowCount,
			int pageCount,String pageUrl) {
