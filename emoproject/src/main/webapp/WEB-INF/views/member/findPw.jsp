...
<div class="page">
    ...
    <h2 id="title">비밀번호 찾기 완료</h2>
    <h2 id="title">비밀번호는 <strong>${mem_passwd}</strong> 입니다.</h2>
	     <div class="page_button2">
          ...
          <input type="button" class="button3" value="회원가입" onclick="location.href='${pageContext.request.contextPath}/member/registerUserForm.do'">
        </div>
      </div>
  </div>
</div>
