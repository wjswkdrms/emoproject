...
create table em_member_manage(
 ...
 mem_reg_date date default sysdate not null,--가입일
 mem_stop_date date,--정지일
...
create table em_member_detail(
 ...
 mem_passwd varchar2(20) not null,--비밀번호
 mem_cell varchar2(15) not null,--전화번호
 mem_email varchar2(50) not null,--이메일
 mem_zipcode varchar2(5) not null,--우편번호
 mem_address1 varchar2(90) not null,--주소
 mem_address2 varchar2(90) not null,--상세주소
 mem_birth varchar2(10) not null, --생일
 mem_gender number(1) not null, -- 성별(1:남자, 2:여자)
 mem_point number(10) not null, -- 보유 포인트 
 mem_mdate date,--마지막 수정일
